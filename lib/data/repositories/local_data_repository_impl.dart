...
class LocalDataRepositoryImpl extends LocalDataRepository{
  ...
  @override
  Future<List<UserEntity>> getAllUsers() async=>await localDataSource.getAllUsers();

  @override
  Future<List<StoryEntity>> getAllStories()async=>await localDataSource.getAllStories();

  @override
  Future<List<PostEntity>> getAllposts() async=>await localDataSource.getAllposts();
